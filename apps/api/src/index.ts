  ...
  const withFeatureRoutes = app
    ...
    .use(
      createDashboardRoutes({
        ...
        aiAdvisorV2Enabled: env.AI_ADVISOR_V2_ENABLED,
        ...
        aiPostMortemEnabled: env.AI_POST_MORTEM_ENABLED,
        aiPostMortemHorizonDays: env.AI_POST_MORTEM_HORIZON_DAYS,
        aiPostMortemBatchLimit: env.AI_POST_MORTEM_BATCH_LIMIT,
        aiPostMortemModel: env.AI_POST_MORTEM_MODEL,
