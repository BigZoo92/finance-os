...
export const createDashboardRouteRuntime = ({
  ...
  return {
    ...
    useCases: {
      ...
      searchAdvisorAssets: investmentStrategy.searchAssets,
      getAdvisorAssetDetails: investmentStrategy.getAssetDetails,
      listAdvisorAssetWatchlist: investmentStrategy.listAssetWatchlist,
      addAdvisorAssetToWatchlist: investmentStrategy.addAssetToWatchlist,
      updateAdvisorAssetWatchlist: investmentStrategy.updateAssetWatchlist,
      removeAdvisorAssetFromWatchlist: investmentStrategy.removeAssetFromWatchlist,
