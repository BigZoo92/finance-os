// @ts-nocheck — React Bits vendored component (pixel-transition)
// Source: https://github.com/DavidHDev/react-bits (MIT + Commons Clause)
// Type checking is disabled: the component uses intricate third-party
// WebGL / gsap / shader state that does not play well with the repo's
// strict-mode tsconfig. Runtime behaviour is unchanged.
