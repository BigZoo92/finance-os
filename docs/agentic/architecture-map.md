...
- Dashboard derived recompute change: [../../apps/api/src/routes/dashboard/routes/derived-recompute.ts](../../apps/api/src/routes/dashboard/routes/derived-recompute.ts), [../../apps/api/src/routes/dashboard/domain/derived-recompute.ts](../../apps/api/src/routes/dashboard/domain/derived-recompute.ts), [../../apps/api/src/routes/dashboard/repositories/dashboard-derived-recompute-repository.ts](../../apps/api/src/routes/dashboard/repositories/dashboard-derived-recompute-repository.ts), [../../apps/web/src/features/dashboard-api.ts](../../apps/web/src/features/dashboard-api.ts), [../../apps/web/src/components/dashboard/app-shell.tsx](../../apps/web/src/components/dashboard/app-shell.tsx)
